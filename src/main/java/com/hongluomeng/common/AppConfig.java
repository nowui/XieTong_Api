...
import com.hongluomeng.controller.CourseController;
import com.hongluomeng.controller.GradeController;
...
import com.hongluomeng.controller.StudentController;
import com.hongluomeng.controller.TeacherController;
...
public class AppConfig extends JFinalConfig {
	...
	public void configPlugin(Plugins plugins) {
	    ...
	    activeRecordPlugin.addMapping("teacher", "teacher_id", Teacher.class);
	    activeRecordPlugin.addMapping("student", "student_id", Student.class);
	    activeRecordPlugin.addMapping("grade", "grade_id", Grade.class);
