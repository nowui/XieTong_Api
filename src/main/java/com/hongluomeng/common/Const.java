...
public class Const {
	...
	public static final String URL_TEACHER_LIST = "/teacher/list";
	public static final String URL_TEACHER_FIND = "/teacher/find";
	public static final String URL_TEACHER_SAVE = "/teacher/save";
	public static final String URL_TEACHER_UPDATE = "/teacher/update";
	public static final String URL_TEACHER_DELETE = "/teacher/delete";
	public static final String URL_TEACHER_LOGIN = "/teacher/login";

	public static final String URL_STUDENT_LIST = "/student/list";
	public static final String URL_STUDENT_FIND = "/student/find";
	public static final String URL_STUDENT_SAVE = "/student/save";
	...
	public static final String URL_COURSE_FIND_2 = "/course/find2";
	public static final String URL_COURSE_SAVE = "/course/save";
	public static final String URL_COURSE_UPDATE = "/course/update";
	...
	public static final String URL_COURSE_APPLY_DELETE = "/course/apply/delete";
	public static final String URL_COURSE_MY = "/course/my";
	...
	public static final String URL_WEB_CONFIG_UPDATE = "/web/config/update";
	public static final String URL_WEB_CONFIG_DELETE = "/web/config/delete";
